    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.attention_on_input = nn.Sequential(
            nn.Linear(n_input, n_hidden), nn.Linear(n_hidden, n_input), nn.Sigmoid()
        )
    ...
    def forward(self, x: torch.Tensor, *cat_list: int):
        ...
        attentive_input = x * self.attention_on_input(x)
        q = self.encoder(attentive_input, *cat_list)
